            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" class="form-control @error('odometer_reading') is-invalid @enderror" 
                           ...
                           value="{{ old('odometer_reading', $vehicle->odometer_reading) }}" min="0" required>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control @error('service_interval') is-invalid @enderror" 
                           ...
                           value="{{ old('service_interval', $vehicle->service_interval) }}" 
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select class="form-select @error('vehicle_status') is-invalid @enderror" 
                        ...
                        <option value="Repair" {{ old('vehicle_status', $vehicle->vehicle_status) == 'Repair' ? 'selected' : '' }}>Repair</option>
                    </select>
