...
<div class="row">
    <div class="col-md-6">
        <fieldset class="fieldset-card">
            <legend>Purpose & Destination</legend>
            <div class="row">
    ...
    <div class="col-md-6">
        <fieldset class="fieldset-card">
            <legend>Vehicle & Estimates</legend>
            <div class="row">
                <div class="col-md-6 mb-3">
        ...
        <fieldset class="fieldset-card">
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                    <div class="row">
                        <div class="col-md-6">
                            <label class="form-label">Operations From</label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Operations To</label>
