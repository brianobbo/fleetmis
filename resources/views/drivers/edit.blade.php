            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('national_id_no') is-invalid @enderror" 
                           ...
                           value="{{ old('national_id_no', $driver->national_id_no) }}" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('license_class') is-invalid @enderror" 
                        ...
                        <option value="B" {{ old('license_class', $driver->license_class) == 'B' ? 'selected' : '' }}>B</option>
                        <option value="CM" {{ old('license_class', $driver->license_class) == 'CM' ? 'selected' : '' }}>CM</option>
                        <option value="DL" {{ old('license_class', $driver->license_class) == 'DL' ? 'selected' : '' }}>DL</option>
                    </select>
                    @error('license_class')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" class="form-control @error('license_expiry') is-invalid @enderror" 
                           ...
                           value="{{ old('license_expiry', $driver->license_expiry->format('Y-m-d')) }}" required>
